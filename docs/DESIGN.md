...
*Status: designed, gated. Does not begin until V1 is live and the Phase-0 tunables are locked. The one rule for this section, same as the rest of the doc: **bake facts, not opinions; label models as models.***
